...
printf "\n> \e[93m\033[1mDeploying video-online-back\e[0m\n\n"
...
ENVIRONMENT=${1}
APP_VERSION=${2}
HELM_APP_NAME="video-online-back-${ENVIRONMENT}"
CHART_DIRECTORY="video-online-back"
VALUES_FILE="./env/${ENVIRONMENT}.yaml"
NAMESPACE="video-online-back-${ENVIRONMENT}"
